...
function plotTrack(raw_data, time) {
    ...
    for (let d in raw_data) {
        switch (raw_data[d]._field) {
            case "m_world_position_x":
                data_x.push(raw_data[d]._value)
                break;
            case "m_world_position_z":
...
function plotTyreSurfaceTemp(raw_data, time) {
    scatterPlot(
        ...
        raw_data,
        time,
        ["m_tyres_surface_temperature_fl", "m_tyres_surface_temperature_fr", "m_tyres_surface_temperature_rl", "m_tyres_surface_temperature_rr"],
        ["FL", "FR", "RL", "RR"],
        [],
        { showgrid: false },
    )
...
function plotTyreInnerTemp(raw_data, time) {
    scatterPlot(
        ...
        raw_data,
        time,
        ["m_tyres_inner_temperature_fl", "m_tyres_inner_temperature_fr", "m_tyres_inner_temperature_rl", "m_tyres_inner_temperature_rr"],
        ["FL", "FR", "RL", "RR"],
        [],
        { showgrid: false },
    )
